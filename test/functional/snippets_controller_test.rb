...
class SnippetsControllerTest < ActionController::TestCase
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post :create, snippet: { absolute_url: @snippet.absolute_url, description: @snippet.description, heading: @snippet.heading, image_url: @snippet.image_url }
    end
  ...
  test "should update snippet" do
    put :update, id: @snippet, snippet: { absolute_url: @snippet.absolute_url, description: @snippet.description, heading: @snippet.heading, image_url: @snippet.image_url }
    assert_redirected_to snippet_path(assigns(:snippet))
  end
